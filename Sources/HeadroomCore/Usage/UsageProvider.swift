...
public enum HeadroomConstants {
    ...
    /// Where the app looks for a newer release. Unauthenticated, so GitHub
    /// allows sixty of these an hour per address, which is far more than a
    /// check every few hours needs.
    public static let latestReleaseURL = URL(string: "https://api.github.com/repos/MariuszT/headroom-ai/releases/latest")!
}
